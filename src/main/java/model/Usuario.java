...
public class Usuario {
	...
	public Usuario(int codigo, String nombre, String apellido, String usuario, String clave, String fecnaci, int tipo,
			int estado) {
		super();
		this.codigo = codigo;
		this.nombre = nombre;
	...
	public String toString() {
		return "Usuario [codigo=" + codigo + ", nombre=" + nombre + ", apellido=" + apellido + ", usuario=" + usuario
				+ ", clave=" + clave + ", fecnaci=" + fecnaci + ", tipo=" + tipo + ", estado=" + estado + "]";
	}
